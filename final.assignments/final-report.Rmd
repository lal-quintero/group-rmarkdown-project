...
For a stronger conclusion, an overall greater sample size, and a balanced proportion of samples for each group is recommended as noted in @shand2017multivariate. 
The covariance matrix heterogeneity in LDA and the low average silhouette of the PAM clusters introduces some uncomfortability in our conclusions, which could 
be strengthened with better sample sizes and a more balanced experimental design.
